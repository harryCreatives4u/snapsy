...
const Messenger = () => {
  ...
  return (
    <div className="relative flex w-full overflow-hidden border border-gray-300 rounded-md shadow-md h-screen-9">
      ...
      <div className="relative flex flex-col w-full px-4 xl:px-2 md:w-9/12 ">
        <ChatWindow messages={messages} />
      </div>
      <button
        onClick={toggleMenu}
        className={`absolute px-2 py-1 text-white transform -rotate-90 bg-blue-800 rounded-lg top-2/4   ${
